...
var setImageTests = []struct {
	...
	},
	{
		...
		wantHeaders: [][]byte{
			...
			{0x2, 0x7, devices[StreamDeckOriginalV2].key(1, 2), 0x0, 0xf8, 0x3, 0x2, 0x0},
			{0x2, 0x7, devices[StreamDeckOriginalV2].key(1, 2), 0x1, 0xd6, 0x1, 0x3, 0x0},
		},
	},
	{
		...
		wantHeaders: [][]byte{
			...
			{0x2, 0x7, devices[StreamDeckMK2].key(1, 2), 0x0, 0xf8, 0x3, 0x2, 0x0},
			{0x2, 0x7, devices[StreamDeckMK2].key(1, 2), 0x1, 0xd6, 0x1, 0x3, 0x0},
		},
	},
	{
		...
		wantHeaders: [][]byte{
			...
			{0x2, 0x7, devices[StreamDeckXL].key(1, 2), 0x1, 0x9d, 0x2, 0x4, 0x0}},
	},
	{
		pid: StreamDeckPedal,
		row: 0, col: 2,
